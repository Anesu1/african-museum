...
const Contact = (props: { contactdataNumber: string }) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        fetch("https://formsubmit.co/ajax/info@africanrecords.africa", {
            method: "POST",
                    ...
                    <div className="flex flex-col gap-14 xl:gap-24">
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            <div className="flex items-center py-3 gap-4 md:gap-8 w-full max-w-xl">
                                ...
                                <p className="section-bedge py-1.5 px-4 rounded-full">Visit Us</p>
                            </div>
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Plan Your Visit</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                    We welcome you to Liberation City. Contact us to book a tour, schedule a school visit, or inquire about our collections.
                                </p>
                                <div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-8">
                                ...
                                {submitted && (
                                    <div className="flex gap-1.5">
                                        ...
                                        <p className="text-secondary">Thank you. Your message has been sent. We will get back to you soon.</p>
                                    </div>
                                )}
                                <div>
                                    {!loader ? (
